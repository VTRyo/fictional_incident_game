...
[title name="Save the Product Crisis!"]
...
;あなたはプロダクトの危機を救うため、みなさんで議論しながら、クイズの回答を考えていきます。
You will work together to discuss and come up with answers to save the product crisis.[p]
;それでは、早速始めましょう！
